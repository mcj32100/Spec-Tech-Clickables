...
// NEW BALLOON
  ...
  else if( this.id === treeIndex ) {
    img=loadImage("assets/1TreeinEye.png");
  }
  else if( this.id === carIndex ) {
    img=loadImage("assets/1CarinEye.png");
  }
...
function newBalloon(idNum) {
  ...
  else if( idNum === carIndex) {
    balloonColor = color('#00FF00');
  }
  else if( idNum === computerIndex) {
